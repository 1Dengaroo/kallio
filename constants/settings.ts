...
export const DEFAULT_VIDEO_MIN_BITRATE = 2000000;
export const DEFAULT_VIDEO_MAX_BITRATE = 10000000;

export const DEFAULT_AUDIO_SAMPLE_RATE = 48000;
export const DEFAULT_AUDIO_BITRATE = 192000;

export const DEFAULT_PREVIEW_SCALE = 2.3;

export const DEFAULT_PREVIEW_WIDTH =
  DEFAULT_VIDEO_WIDTH / DEFAULT_PREVIEW_SCALE;

export const DEFAULT_PREVIEW_HEIGHT =
  DEFAULT_VIDEO_HEIGHT / DEFAULT_PREVIEW_SCALE;

export const MIN_MEDIA_PANEL_WIDTH = 184;
export const DEFAULT_MEDIA_PANEL_WIDTH = 348;
export const MAX_MEDIA_PANEL_WIDTH = 512;

export const DEFAULT_SETTINGS_PANEL_WIDTH = 300;

export const DEFAULT_MIN_FADE = 0;
export const DEFAULT_MAX_FADE = 5000;
export const DEFAULT_FADE_STEP = 1;
export const DEFAULT_FADE_IN = 0;
export const DEFAULT_FADE_OUT = 0;

export const DEFAULT_MIN_ROTATION = 0;
export const DEFAULT_MAX_ROTATION = 359;
export const DEFAULT_ROTATION_STEP = 1;
